...
System.out.println("Bilanga Genap : " + a);
}    
...
for (int kelas = 0; kelas < jumlahKelas; kelas++) {String namaKelas = JOptionPane.showInputDialog(null, "NamaKelas :", "Masukan Nama Kelas",
JOptionPane.INFORMATION_MESSAGE);
int jumlahKursi =Integer.parseInt(JOptionPane.showInputDialog(null, "Jumlah murid masing - masing kelas : ",
"Input",
JOptionPane.INFORMATION_MESSAGE));
isiKelas[kelas] = new
String[jumlahKursi];
